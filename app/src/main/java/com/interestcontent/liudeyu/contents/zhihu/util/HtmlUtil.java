package com.interestcontent.liudeyu.contents.zhihu.util;
...
public class HtmlUtil {
    ...
    public static String createCssTag(List<String> urls) {
        ...
        sb.append("<meta charset=\"utf-8\" name=\"viewport\" content=\"width=device-width, initial-scale=1, maximum-scale=1\">");
        return sb.toString();
    }
    ...
    public static String createHtmlData(String html, List<String> cssList, List<String> jsList) {
        ...
        String content = css.concat(HIDE_HEADER_STYLE).concat(html).concat(js);
        return content;
    }
}
